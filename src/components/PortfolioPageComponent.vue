...
<div style="padding: 12px;">
    <div style="margin-bottom: 6px;">
        ...
        <small>Combine tickers into a portfolio, and this itself becomes a ticker you can use. All portfolio tickers are prefixed with a dollarsign</small>
    </div>
    <template v-for="(portfolio, i) in portfolioService.portfolioTickers.value">
        <div style="width: 100%; background: #333; padding: 8px 12px;  border-radius: 4px; box-shadow: 1px 1px 3px #00000055; position: relative; margin-bottom: 12px;">
            <h3 style="margin-bottom: 4px;">${{portfolio.baseName}} &nbsp; <small style="font-weight: 400;">rebalance every {{ portfolio.rebalanceDays }} days</small></h3>
